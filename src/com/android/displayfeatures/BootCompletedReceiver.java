...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        ComponentName cn = new ComponentName(PKG_NAME, DC_DIM_TILE_CLASS_NAME);
        int state = Fileutils.fileExists(mConfig.getDcDimPath())
        ...
        state = Fileutils.fileExists(mConfig.getFpsPath())
                ? COMPONENT_ENABLED_STATE_ENABLED : COMPONENT_ENABLED_STATE_DISABLED;
        pm.setComponentEnabledSetting(cn, state, 0);
